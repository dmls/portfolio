$(document).ready(function() {
    ...
    var words = ['PHP', 'JavaScript', 'jQuery', 'Linux', 'SCSS', 'SASS', 'CSS', 'MySQL', 'MongoDB', 'AWS', 'Git', 'SVN', 'CodeCommit', 'Elastic Beanstalk', 'S3', 'EC2', 'VSCode', 'Vim', 'Apache', 'WordPress', 'Magento', 'React', 'CMS', 'eCommerce'].map(function(word) {
        return {
            word: word,
